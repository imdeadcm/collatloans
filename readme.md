...
We provide two implementations, the transitive tournament and the linear graph implementation. The code also computes the time it takes for the oracle to attest a full block (2000 transactions) and the total size of the signatures.
